...
// 1. ¡CRUCIAL! Fuerza a Astro a generar esta imagen en el build.
// De esta forma, WhatsApp no activa el backend, sino que descarga un archivo estático inmediato.
...
export async function GET() {
      ...
      props: {
        ...
        children: [
          // LADO IZQUIERDO: FOTO
          {
            type: "div",
            props: {
              style: { width: "40%", height: "100%", display: "flex" },
              children: [
                {
                  type: "img",
                  props: {
  ...
  // 2. Agrega cabeceras de control de caché para indicarle a Meta que guarde la imagen
  return new Response(new Uint8Array(pngData), {
    headers: {
